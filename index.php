...
$megaList = [
	"Women" => [
		"Dresses" => "single.html",
		"Tops" => "single.html",
		"Sweaters/Knits" => "single.html",
		"Jackets/Coats" => "single.html",
		"Blazers" => "single.html",
		"Denim" => "single.html",
		"Leggings/Pants" => "single.html",
		"Skirts/Shorts" => "single.html",
		"Accessories" => "single.html",
	],
	"Men" => [
		"Tees/Tank tops" => "single.html",
		"Shirts/Polos" => "single.html",
		"Sweaters" => "single.html",
		"Sweatshirts/Hoodies" => "single.html",
		"Blazers" => "single.html",
		"Jackets/vests" => "single.html",
	]
];

function renderMegaList($list, $category) {
  $list = $list["$category"];
			...
			<div class="browse">
				...
				<div class="drop-down">
					<div class="drop-down-flex">
						<h3>WOMEN</h3>
						<ul class="mega-list">
							<?php renderMegaList($megaList, 'Women') ?>
						</ul>
					</div>
					<div class="mega-flex">
						<h3>MEN</h3>
						<ul class="mega-list">
							<?php renderMegaList($megaList, 'Men') ?>
						</ul>
					</div>
				</div>
			</div>
